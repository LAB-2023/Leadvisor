  ...
  try {
    ...
    db.query(sql1, BIZ_ID, (err, result) => {
      if (!err) {
        //console.log(result);
        res.send({
          status: "WorkerHeart success",
          data: result,
        });
      } else {
        console.log("WorkerHeart Data error");
