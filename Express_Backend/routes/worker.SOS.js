  ...
  try {
    ...
    db.query(sql1, BIZ_ID, (err, result) => {
      if (!err) {
        ...
        //console.log(result);
        res.send({
          status: "WorkerSOS success",
          data: result,
        });
      } else {
        console.log("WorkerSOS Data error");
